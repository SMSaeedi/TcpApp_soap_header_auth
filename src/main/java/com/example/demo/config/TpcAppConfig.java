...
import com.example.demo.webService.impl.ChangePaymentImpl;
import com.example.demo.webService.impl.NewCustomerImpl;
import com.example.demo.webService.impl.NewProductImpl;
import com.example.demo.webService.impl.ProductDetailImpl;
...
public class TpcAppConfig implements BeanFactoryPostProcessor {
    ...
    @Bean
    public ChangePayment changePayment() {
   ...
   /* @Bean
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory factory) throws BeansException {
        Arrays.stream(new String[]{"changePayment", "newCustomer", "productDetail", "newProduct"})
                .forEach(str -> {
